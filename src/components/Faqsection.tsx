...
export default function FaqSection() {
  ...
  return (
    ...
    >
      {/* Wrapping Div */}
      <div className="container text-white flex flex-col justify-center items-center mx-auto flex-grow py-20">
        {/* Heading */}
        <h2 className="text-[25px] md:text-[35px] lg:text-[48px] bg-gradient-to-r from-[#CCCCCC] to-[#666666] bg-clip-text text-transparent font-poppins">
          Frequently Asked Questions
        </h2>

        {/* FAQ Questions and Answers */}
        <div className="w-full max-w-3xl mx-auto mt-8 space-y-6 px-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="bg-gradient-to-r from-[#24063F] to-[#5F10A5] p-6 rounded-lg shadow-lg cursor-pointer"
              onClick={() => toggleFAQ(index)}
            >
              <div className="flex justify-between items-center">
                <p className="text-xl font-inder bg-gradient-to-r from-[#FFFFFF] to-[#999999] bg-clip-text text-transparent">
                  {faq.question}
                </p>
                <Image
                  src={dropdown}
              ...
              {openIndex === index && (
                <div className="mt-4">
                  <p className="font-inder bg-gradient-to-r from-[#CCCCCC] to-[#b4b2b2] bg-clip-text text-transparent">
                    {faq.answer}
                  </p>
                </div>
              )}
