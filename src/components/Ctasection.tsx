    ...
    >
      ...
      <div className="container text-white flex-col overflow-clip justify-center items-center flex mx-auto mt-35 md:mt-50 lg:flex-row lg:mt-10">
        ...
        <div className="relative flex-col flex items-center w-full lg-w-1/2">
          ...
          <Link href="/Goback">
            <button className="bg-[linear-gradient(to_right,#24063F_30%,#5F10A5)] hover:scale-105 text-white font-light py-3 px-6 md:px-16 md:py-4 rounded-lg shadow-md transition-all mt-20 font-poppins md:mt-30">
              Get Your AI Resume Now
            </button>
          </Link>
          <Link href="#faq" className="mt-3 flex hover:scale-103">
            <span className="bg-[linear-gradient(to_right,#CEB7E3_60%,#71657D)] bg-clip-text text-transparent md:text-[15px]">
              Learn More
            </span>
            <span>
