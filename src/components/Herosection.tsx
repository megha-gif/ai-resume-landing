...
//         {/* Glowing Ring */}
//         <div className="absolute top-[150px] md:top-8  rounded-full glowing-ring opacity-60 mix-blend-screen  h-[280px] w-[400px] md:h-[350px] md:w-[500px] lg:h-[400px] lg:w-[510px]  border-[32px] border-[#8a2be2]"></div>
//         {/* Content */}
...
const Herosection = () => {
  return (
    // Hero Section
    <div id="#cta" className="bg-black relative overflow-hidden min-h-screen flex flex-col">
      {/* Wrapping Div */}
      <div className="container text-white flex overflow-clip flex-col justify-center items-center mx-auto flex-grow">
        {/* Glowing Ring */}
      ...
      {/* Linear Gradient at bottom */}
      <div className="h-[100px] w-full bg-gradient-to-b from-transparent to-[#52057B] mt-auto"></div>
    </div>
  );
};
